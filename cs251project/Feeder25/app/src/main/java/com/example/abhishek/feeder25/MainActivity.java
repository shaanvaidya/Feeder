...
//        }
        ...
        try {
            JSONArray outer = new JSONArray(jsonString);
//            System.out.println("Outer"+outer.length());
...
///        Date date=new Date(2016,12,11);
//        SimpleDateFormat sdf=new SimpleDateFormat("22-12-2016");
//        System.out.println(jsonString);
        for(int i=0; i< dead.size();i++){
            switch(cold.get(dead.get(i).code)){
                case 0 : caldroidFragment.setBackgroundDrawableForDate(green,dead.get(i).due_date);
                        break;
                case 1 :ColorDrawable aqua = new ColorDrawable(Color.CYAN);
                        caldroidFragment.setBackgroundDrawableForDate(aqua,dead.get(i).due_date);
                        break;
                case 2 : ColorDrawable blue = new ColorDrawable(Color.BLUE);
                        caldroidFragment.setBackgroundDrawableForDate(blue,dead.get(i).due_date);
                        break;
                case 3 :ColorDrawable red = new ColorDrawable(Color.RED);
                        caldroidFragment.setBackgroundDrawableForDate(red,dead.get(i).due_date);
                        break;
                case 4 :ColorDrawable yellow = new ColorDrawable(Color.YELLOW);
                        caldroidFragment.setBackgroundDrawableForDate(yellow,dead.get(i).due_date);
                        break;
                case 5 :ColorDrawable magenta = new ColorDrawable(Color.MAGENTA);
        ...
        for(int i=0; i< feed.size();i++){
            switch(cold.get(feed.get(i).code)){
                case 0 : caldroidFragment.setBackgroundDrawableForDate(green,feed.get(i).due_date);
                    break;
                case 1 :ColorDrawable aqua = new ColorDrawable(Color.CYAN);
